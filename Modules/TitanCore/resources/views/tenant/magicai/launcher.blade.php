...
<div class="container-fluid">
    <div class="row mb-3">
        <div class="col">
            ...
            <div class="text-muted">Use MagicAI features inside Worksuite via TitanCore gateway.</div>
        </div>
    </div>
        ...
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-md-10">
                    ...
                    <div class="form-text">This path is forwarded to MagicAI. Example: /api/chat/send-message</div>
                </div>
                <div class="col-12">
