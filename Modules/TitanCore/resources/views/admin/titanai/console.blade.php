...
<div class="container-fluid">
    <div class="row mb-3">
        <div class="col">
            <h3 class="mb-1">Titan AI Console</h3>
            <div class="text-muted">Proxy any Titan AI API route through TitanCore (permission gated).</div>
        </div>
    </div>

    <div class="card">
        <div class="card-body">
            <form id="titanaiConsoleForm" class="row g-3">
                <div class="col-md-2">
                ...
                <div class="col-12 d-flex gap-2">
                    ...
                    <button type="button" class="btn btn-outline-secondary" onclick="pingTitan AI()">Ping</button>
                </div>
