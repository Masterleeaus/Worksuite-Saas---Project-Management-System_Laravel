    ...
    <div class="col-md-4">
      <x-card>
        ...
        <x-slot name="body">
          ...
          <div class="mb-1">Overdue approvals: <strong>{{ $compliance['overdue_approvals'] ?? 0 }}</strong></div>
          <div class="mb-1">Documents: <strong>{{ $compliance['documents_count'] ?? 0 }}</strong></div>
          <div>QC failing/reclean: <strong>{{ $compliance['qc_failing'] ?? 0 }}</strong></div>
        </x-slot>
      </x-card>
    </div>
    <div class="col-md-4">
