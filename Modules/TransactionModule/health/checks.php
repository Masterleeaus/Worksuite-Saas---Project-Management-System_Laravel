...
return [
    [
        'id' => 'transactionmodule:module_json',
    ...
    [
        'id' => 'transactionmodule:service_provider',
    ...
    [
        'id' => 'transactionmodule:routes_web',
    ...
    [
        'id' => 'transactionmodule:migrations_dir',
    ...
    [
        'id' => 'transactionmodule:views_dir',
