...
namespace Modules\PromotionManagement\Services\Ai;
...
class TitanZeroBridge
{
    ...
    public function ingestSignal(array $signal, $tenantId = null): array
    {
        try {
            ...
            Log::warning('[TitanAI] ingestSignal failed', ['module' => 'PromotionManagement', 'err' => $e->getMessage()]);
    ...
    public function runAgent(string $agentSlug, array $context, $tenantId = null): ?array
    {
        try {
            ...
            Log::warning('[TitanAI] runAgent failed', ['module' => 'PromotionManagement', 'agent' => $agentSlug, 'err' => $e->getMessage()]);
            return null;
        }
    }
