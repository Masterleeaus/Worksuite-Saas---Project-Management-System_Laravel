...
return [
    [
        'id' => 'promotionmanagement:module_json',
    ...
    [
        'id' => 'promotionmanagement:service_provider',
    ...
    [
        'id' => 'promotionmanagement:routes_web',
    ...
    [
        'id' => 'promotionmanagement:migrations_dir',
    ...
    [
        'id' => 'promotionmanagement:views_dir',
    ...
    [
        'id' => 'promotionmanagement:lang_dir',
