<div class="mb-3">
    ...
    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
           value="{{ old('name', $branch->name ?? '') }}" required maxlength="256">
...
<div class="mb-3">
    ...
    <input type="text" name="description" class="form-control @error('description') is-invalid @enderror"
           value="{{ old('description', $branch->description ?? '') }}" maxlength="512">
...
<div class="d-flex gap-2">
    ...
    <a href="{{ route('fsmterritory.branches.index') }}" class="btn btn-secondary">Cancel</a>
</div>
