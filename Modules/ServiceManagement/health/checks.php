...
return [
    [
        'id' => 'servicemanagement:module_json',
    ...
    [
        'id' => 'servicemanagement:service_provider',
    ...
    [
        'id' => 'servicemanagement:routes_web',
    ...
    [
        'id' => 'servicemanagement:migrations_dir',
    ...
    [
        'id' => 'servicemanagement:views_dir',
