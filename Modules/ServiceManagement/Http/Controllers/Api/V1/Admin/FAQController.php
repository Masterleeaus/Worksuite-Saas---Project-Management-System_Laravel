...
class FAQController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $faq->visibility = $request->get('visibility', $faq->visibility ?? 'team');
        $faq->source_type = $request->get('source_type', $faq->source_type ?? 'user');
        $faq->tags = $request->get('tags');
        $faq->company_id = optional(auth()->user())->company_id ?? $faq->company_id;
