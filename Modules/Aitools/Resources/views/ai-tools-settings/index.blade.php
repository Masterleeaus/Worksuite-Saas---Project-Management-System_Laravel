                ...
                <div class="s-b-n-header" id="tabs">
                    <nav class="tabs px-4 border-bottom-grey">
                        <div class="nav" id="nav-tab" role="tablist">
                            ...
                            <a class="nav-item nav-link f-15 {{ ($activeTab ?? 'settings') == 'providers' ? 'active' : '' }} providers"
                               href="{{ route('ai-tools.providers.index') }}"
                               role="tab"
                               aria-selected="{{ ($activeTab ?? 'settings') == 'providers' ? 'true' : 'false' }}">
                                <i class="fa fa-plug mr-2"></i>Providers
                            </a>
                            <a class="nav-item nav-link f-15 {{ ($activeTab ?? 'settings') == 'prompts' ? 'active' : '' }} prompts"
                               href="{{ route('ai-tools.prompts.index') }}"
                               role="tab"
                               aria-selected="{{ ($activeTab ?? 'settings') == 'prompts' ? 'true' : 'false' }}">
                                <i class="fa fa-file-alt mr-2"></i>Prompts
                            </a>
                            <a class="nav-item nav-link f-15 {{ ($activeTab ?? 'settings') == 'tools' ? 'active' : '' }} tools"
                               href="{{ route('ai-tools.tools.index') }}"
                               role="tab"
                               aria-selected="{{ ($activeTab ?? 'settings') == 'tools' ? 'true' : 'false' }}">
...
@php($tab = $activeTab ?? request('tab', 'settings') ?? 'settings')
@if($tab == 'usage')
...
@elseif($tab == 'providers')
    @include('aitools::ai-tools-settings.tabs.providers')
@elseif($tab == 'prompts')
    @include('aitools::ai-tools-settings.tabs.prompts')
@elseif($tab == 'tools')
    @include('aitools::ai-tools-settings.tabs.tools')
@else
                    {{-- Settings Tab --}}
                    <div class="row">
                        <div class="col-lg-12 mb-4">
