...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        Schema::create('biolink_blocks', function (Blueprint $table) {
            ...
            $table->string('text_alignment')->nullable()->default(Alignment::CENTER->value);
            ...
            $table->string('object_fit')->default(ObjectFit::COVER->value);
            $table->string('border_radius')->default(BorderRadius::STRAIGHT->value);
            $table->string('border_width')->nullable()->default('0');
            $table->string('border_color')->nullable()->default('#000000');
            $table->string('border_style')->default(BorderStyle::SOLID->value);
