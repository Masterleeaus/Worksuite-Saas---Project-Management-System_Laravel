...
use Modules\Testimonials\Console\ActivateModuleCommand;
...
protected function registerConfig(): void
{
    ...
    public function registerViews(): void
    {
        ...
        $componentNamespace = $this->moduleNamespace($this->name, is_string($componentPath) ? $this->appPath($componentPath) : null);
