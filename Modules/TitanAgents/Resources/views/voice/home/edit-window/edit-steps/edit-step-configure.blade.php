    ...
    <div class="flex flex-col gap-7 pt-9">
        ...
        <div>
            ...
            >
                ...
                @foreach ([\'en\' => ['name' => 'English'], \'es\' => ['name' => 'Spanish'], \'fr\' => ['name' => 'French'], \'de\' => ['name' => 'German'], \'it\' => ['name' => 'Italian'], \'pt\' => ['name' => 'Portuguese'], \'nl\' => ['name' => 'Dutch'], \'ar\' => ['name' => 'Arabic'], \'zh\' => ['name' => 'Chinese'], \'ja\' => ['name' => 'Japanese']] as $localeCode => $properties)
@if(true)
