...
>
    ...
    <div class="lqd-ext-chatbot-training mt-16 flex flex-col justify-center gap-9">
        ...
        <div class="lqd-ext-chatbot-training-content grid">
            @include('titanagents::voice.home.training.training-tabs.training-tab-website')
            @include('titanagents::voice.home.training.training-tabs.training-tab-pdf')
            @include('titanagents::voice.home.training.training-tabs.training-tab-text')
        </div>
    </div>
                ...
                Alpine.data('externalChatbotTraining', () => ({
                    ...
                    async fetchEmbeddings() {
                        ...
                        const res = await fetch(
                            `{{ route('titanagents.voice.train.data') }}?id=${this.activeChatbot.id}`
                        );
                    ...
                    async deleteEmbedding(embeddingId) {
                        ...
                        const res = await fetch(
                            '{{ route('titanagents.voice.train.delete') }}', {
                                method: 'DELETE',
                                headers: {
                                    'Content-Type': 'application/json',
                                    'Accept': 'application/json',
