            ...
            <div class="flex flex-wrap items-center justify-between gap-4 px-3 py-3 lg:h-[--header-height] lg:px-12">
                ...
                <div class="lqd-steps hidden flex-col gap-1 lg:flex">
                    <div class="lqd-steps-steps flex items-center justify-between gap-1 lg:gap-3">
                        @foreach (\Modules\TitanAgents\Enums\Voice\StepEnum::toArray() as $step)
                            <button
        ...
        <div class="lqd-chatbot-edit-window-content py-8 lg:py-0">
            <div class="container flex flex-wrap justify-center gap-y-5">
                ...
                <div
                    ...
                    >
                    @include('titanagents::voice.home.edit-window.edit-steps.edit-step-configure')
                    @include('titanagents::voice.home.edit-window.edit-steps.edit-step-customize', [
                        'avatars' => $avatars,
                    ])
                    @include('titanagents::voice.home.edit-window.edit-steps.edit-step-train')
                    @include('titanagents::voice.home.edit-window.edit-steps.edit-step-embed')
                    <div
            ...
            document.addEventListener('alpine:init', () => {
                Alpine.data('customAvatar', () => ({
                    ...
                    async onPickerChange() {
                        ...
                        await fetch('{{ route('titanagents.voice.upload.avatar') }}', {
                                method: 'POST',
                                body: formData,
                            })
                            .then(response => {
