...
>
    ...
    >
        ...
        <div
            ...
            @include('titanagents::voice.home.chats-history.chats-list')
            ...
            >
                <x-button
                    ...
                    variant="link"
                    href="{{ route('titanagents.voice.conversation.with.paginate', ['page' => 1]) }}"
                    x-ref="loadMore"
    ...
    <div class="lqd-ext-chatbot-history-content-wrap flex grow flex-col max-sm:h-[70vh]">
        ...
        <div class="lqd-ext-chatbot-history-messages-wrap grow overflow-hidden">
            ...
            >
                @include('titanagents::voice.home.chats-history.chat-messages')
            </div>
        </div>
