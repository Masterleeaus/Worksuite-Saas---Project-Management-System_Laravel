...
@section('content')
    <div class="py-10">
        ...
        >
            @include('titanagents::voice.home.actions-grid')

            @include('titanagents::voice.home.chatbots-list', ['chatbots' => $chatbots])

            @include('titanagents::voice.home.edit-window.edit-window', ['avatars' => $avatars])
        </div>

        @include('titanagents::voice.home.chats-history.chats-history')
    </div>
@endsection
            ...
            document.addEventListener('alpine:init', () => {
                Alpine.data('externalChatbotEditor', () => ({
                    ...
                    async updateChatbot(chatbot) {
                        ...
                        const res = await fetch(
                            '{{ route('titanagents.voice.update') }}', {
                                method: 'PUT',
                                headers: {
                                    'Accept': 'application/json',
                                    'Content-Type': 'application/json',
