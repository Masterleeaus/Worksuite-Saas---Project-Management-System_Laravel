...
class QcCreateScheduleRepliesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if (!Schema::hasTable('inspection_schedule_replies')) {
            if (!Schema::hasTable('inspection_schedule_replies')) Schema::create('inspection_schedule_replies', function (Blueprint $table) {
            $table->increments('id');
