...
return [
    ...
    */
    ...
    'signals' => [
        'payment_success' => ['severity' => 'green', 'facts' => ['transaction_id','payer_id','amount','payment_method']],
        'payment_fail' => ['severity' => 'amber', 'facts' => ['transaction_id','payer_id','amount','payment_method']],
        'subscription_success' => ['severity' => 'green', 'facts' => ['transaction_id','payer_id','payment_method','additional_data']],
        'subscription_fail' => ['severity' => 'amber', 'facts' => ['transaction_id','payer_id','payment_method','additional_data']],
