...
use Modules\BookingModule\Http\Controllers\Api\V1\Public\BookingWidgetController as PublicBookingWidgetController;
...
Route::prefix('public/booking')->as('public.booking.')->group(function () {
    Route::get('services', [PublicBookingWidgetController::class, 'services'])->name('services');
    Route::get('availability', [PublicBookingWidgetController::class, 'availability'])->name('availability');
    Route::post('request', [PublicBookingWidgetController::class, 'request'])->name('request');
    Route::post('quote-request', [PublicBookingWidgetController::class, 'quoteRequest'])->name('quote-request');
    Route::get('portal-summary', [PublicBookingWidgetController::class, 'portalSummary'])->name('portal-summary');
    Route::get('portal-bookings', [PublicBookingWidgetController::class, 'portalBookings'])->name('portal-bookings');
    Route::get('job-status/{reference}', [PublicBookingWidgetController::class, 'jobStatus'])->name('job-status');
});
