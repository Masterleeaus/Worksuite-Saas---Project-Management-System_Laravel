...
@include('bookingmodule::dashboard.widgets._appointments_unassigned')
@include('bookingmodule::dashboard.widgets._appointments_my')
                                    ...
                                    <tr>
                                        <td>
                                            <div class="font-14 my-1">
                                                <a href="{{ route('appointment.schedules.show', [\Crypt::encrypt($appointment->appointment_id)]) }}"
