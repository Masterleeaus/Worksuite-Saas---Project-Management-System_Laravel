                        ...
                        <table class="table mb-0 pc-dt-simple" id="assets">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{ __('Staff') }}</th>
                                    <th>{{ __('Status') }}</th>
                                    @if (\Modules\BookingModule\Support\AppointmentPermission::check(auth()->user(), 'schedule edit') || \Modules\BookingModule\Support\AppointmentPermission::check(auth()->user(), 'schedule delete'))
                            ...
                            <tbody>
                                @foreach ($schedule as $schedules)
                                    <tr>
                                        ...
                                        <td>
                                            @if (!empty($schedules->assignee))
                                                {{ $schedules->assignee->name }}
                                            @else
                                                <span class="badge bg-secondary p-2 px-3 rounded">{{ __('Unassigned') }}</span>
                                            @endif
                                        </td>
                                        <td>
                                        ...
                                        @if (\Modules\BookingModule\Support\AppointmentPermission::check(auth()->user(), 'schedule edit') || \Modules\BookingModule\Support\AppointmentPermission::check(auth()->user(), 'schedule delete') || \Modules\BookingModule\Support\AppointmentPermission::check(auth()->user(), 'schedule action'))
                                            <td class="Action">
                                                <span>
