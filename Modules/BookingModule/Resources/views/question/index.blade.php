...
@section('page-action')
    <div>
        @if(\Modules\BookingModule\Support\AppointmentPermission::check(auth()->user(), 'question create'))
                        ...
                        <table class="table mb-0 pc-dt-simple" id="assets">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{ __('Enabled') }}</th>
                                    @if (\Modules\BookingModule\Support\AppointmentPermission::check(auth()->user(), 'question edit') || \Modules\BookingModule\Support\AppointmentPermission::check(auth()->user(), 'question delete'))
