...
@endsection
@section('content')
    @include('bookingmodule::appointment.partials._filters')
<div class="row">
        <div class="col-sm-12">
            <div class="card">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    @if (\Modules\BookingModule\Support\AppointmentPermission::check(auth()->user(), 'appointments edit') ||
                                            \Modules\BookingModule\Support\AppointmentPermission::check(auth()->user(), 'appointments delete') ||
                                            \Modules\BookingModule\Support\AppointmentPermission::check(auth()->user(), 'appointments show') ||
                                            \Modules\BookingModule\Support\AppointmentPermission::check(auth()->user(), 'appointments copy link') ||
                                            \Modules\BookingModule\Support\AppointmentPermission::check(auth()->user(), 'schedule show'))
                                                ...
                                                <span>
                                                    @if(\Modules\BookingModule\Support\AppointmentPermission::check(auth()->user(), 'schedule show'))
                                                        <div class="action-btn bg-black ms-2">
                                                            <a href="{{ route('appointment.schedules.show', \Crypt::encrypt($appointments->id)) }}"
                                                    ...
                                                    @endif
                                                    @if(\Modules\BookingModule\Support\AppointmentPermission::check(auth()->user(), 'appointments copy link'))
