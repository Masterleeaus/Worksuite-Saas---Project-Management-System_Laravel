...
Route::group(['middleware' => 'auth', 'prefix' => 'account'], function () {
    ...
    Route::resource('security/access-cards', AccessCardController::class);
    ...
    Route::resource('security/inout-permits', InOutPermitController::class);
    ...
    Route::resource('security/work-permits', WorkPermitController::class);
    ...
    Route::resource('security/packages', PackageController::class);
    ...
    Route::resource('security/parking', ParkingController::class);
    ...
    Route::resource('security/notes', NoteController::class);
});

// ACCESS LOGS - Real-time access events
