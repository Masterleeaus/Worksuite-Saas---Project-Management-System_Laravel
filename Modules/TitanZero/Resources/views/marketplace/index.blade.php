...
@php
    $path = url("/Modules/TitanZero/marketplace");
@endphp
@section('page-title')
    {{ __('Software Details') }}
@endsection
    ...
    <section class="dedicated-themes-section padding-bottom">
        <div class="container">
            <div class="section-title text-center">
                ...
                <p>{{__('TitanZero can be used to generate content that is both high-quality and engaging. It can also be used to personalize content for specific target audiences.')}}</p>
            </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('Some Benefits of Using TitanZero')}}</h2>
                        </div>
                        <p>{{__('TitanZero can generate high-quality content that is both informative and engaging. TitanZero can personalize your content for specific target audiences, ensuring that your message resonates with your readers. TitanZero can generate content that is optimized for search engines, helping you to drive more traffic to your website.')}}</p>
                    </div>
                </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('What is use of TitanZero?')}}</h2>
                        </div>
                        <p>{{__('TitanZero can automate tasks such as scheduling appointments, managing finances, and providing reminders. This can save you time and effort, and help you to be more productive.  TitanZero is being used to create content for a variety of industries, including marketing, advertising, and education. For example, TitanZero can be used to generate blog posts, social media captions.')}}</p>
                    </div>
                </div>
            </div>
        </div>
