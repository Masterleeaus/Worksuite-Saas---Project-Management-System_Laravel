...
<div class="modal-body">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <select name="language" class="form-select" id="language">
                            @foreach ( \Modules\TitanZero\Entities\AssistantTemplate::flagOfCountry() as $key => $lang)
    ...
    <script>
        ...
        $('body').on('change','.template_name',function(){
            ...
            $.ajax({
                type:'post',
                url: '{{route("titan-zero.generate.keywords",['__templateId'])}}'.replace('__templateId', templateId),
                datType: 'json',
                data: {
                   '_token': '{{ csrf_token() }}',
    ...
    $('body').on('click','#generate',function(){
        ...
        $.ajax({
            type:'post',
            url : '{{ route('titan-zero.generate.response') }}',
            datType: 'json',
            data:form.serialize(),
