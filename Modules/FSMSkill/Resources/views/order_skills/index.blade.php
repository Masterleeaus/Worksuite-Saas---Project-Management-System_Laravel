...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h2>Skill Requirements – Order: {{ $order->name }}</h2>
...
<div class="row g-4">
                ...
                <table class="table table-sm mb-0">
                    ...
                    @forelse($requirements as $req)
                        <tr>
                            ...
                            <td>
                                <form method="POST" action="{{ route('fsmskill.order-skills.destroy', [$order->id, $req->id]) }}"
    ...
    <div class="col-md-5">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('fsmskill.order-skills.store', $order->id) }}">
                    @csrf
                    <div class="mb-2">
