...
@section('content')
    <div class="content-wrapper">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h3 class="heading-h1">@lang('projectroadmap::app.roadmap.addItem')</h3>
        ...
        <div class="card">
            <div class="card-body">
                <form id="roadmap-item-form" method="POST" action="{{ route('roadmap.admin.store') }}">
                    @csrf
                    <div class="row">
                        <div class="col-md-8">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="target_release" class="form-control" placeholder="e.g. Q3 2026" value="{{ old('target_release') }}">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="release_notes" class="form-control" rows="3">{{ old('release_notes') }}</textarea>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
