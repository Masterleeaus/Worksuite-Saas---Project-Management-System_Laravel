...
return [
    [
        'id' => 'providermanagement:module_json',
    ...
    [
        'id' => 'providermanagement:service_provider',
    ...
    [
        'id' => 'providermanagement:routes_web',
    ...
    [
        'id' => 'providermanagement:migrations_dir',
    ...
    [
        'id' => 'providermanagement:views_dir',
    ...
    [
        'id' => 'providermanagement:lang_dir',
