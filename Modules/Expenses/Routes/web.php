...
Route::middleware(['web','auth','can:expenses.access'])->prefix('expenses')->name('module-expenses.')->group(function(){ Route::get('/',[ExpensesController::class,'index'])->name('index'); Route::get('/create',[ExpensesController::class,'create'])->name('create'); Route::post('/',[ExpensesController::class,'store'])->name('store');});
...
Route::middleware(['web','auth','can:expenses.access'])->prefix('expenses')->name('module-expenses.')->group(function(){
