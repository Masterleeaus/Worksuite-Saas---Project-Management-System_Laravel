...
@section('content')
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-header">
                            {{-- <h5 class="mb-0">Products List ({!! $name ?? $type !!}) </h5> --}}
                            <div class="row" style="display: flex;justify-content: space-between;">
                                <div class="col-sm-4"><h5 class="mb-0">Parent Brands List </h5>
                                </div>
                                <div class="col-sm-4"><form action="{{ url('products/create') }}" method="GET">
                                    <button type="submit" class="btn btn-outline-primary mb-3">Add  New  Product </button>
                                </form></div>
                        </div>
 ...
 <script>
       $('.datatable_search').DataTable({
            ...
            ajax: "{{ url('products/any-data/' . $type . '/' . $table . '/' . $id) }}",
            select: false,
