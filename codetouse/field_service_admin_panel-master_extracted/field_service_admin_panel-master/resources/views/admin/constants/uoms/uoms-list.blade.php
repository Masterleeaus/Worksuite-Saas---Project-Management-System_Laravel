                                    ...
                                    <div class="card card-plain">
                                        ...
                                        <div class="card-body">
                                            ...
                                            {{-- <div hidden >
                                                ...
                                                {!! Form::label('u_uom', 'Category:', ['class' => 'control-label']) !!}
                                                {!! Form::select('u_uom', $uoms->pluck('name_en', 'id'), null, ['class' => 'form-select']) !!}

                                            </div> --}}
                                            <input hidden readonly name="u_uom"  id="u_uom" value="9" type="text"/>
                        ...
                        <div class="card">
                             <div class="card-header">
                                ...
                                <div class="row" style="display: flex;justify-content: space-between;">
                                    <div class="col-sm-4"><h5 class="mb-0">UOM List </h5>
                                    </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            if (uoms.length > 0) {
                ...
                document.getElementById("u_name_en").value = uoms[0].name_en;
                document.getElementById("u_uom").value = uoms[0].id;
...
if (index> -1) {
    ...
    document.getElementById("u_name_en").value = uoms[index].name_en;
    document.getElementById("u_uom").value = uoms[index].id;
