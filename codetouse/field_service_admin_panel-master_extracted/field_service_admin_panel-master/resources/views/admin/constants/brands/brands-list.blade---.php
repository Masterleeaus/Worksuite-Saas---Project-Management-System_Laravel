            ...
            <div class="row">
                <div class="col-md-3">
                    <button type="button" class="btn btn-outline-primary mb-3" data-bs-toggle="modal"
                        data-bs-target="#modal-form">Add New Category</button>
                ...
                <div class="col-md-3">
                    <button type="button" class="btn btn-outline-primary mb-3" data-bs-toggle="modal"
                        data-bs-target="#modal-form-update">Update Category</button>
                                    ...
                                    <div class="card card-plain">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div>
                                                ...
                                                {!! Form::label('u_category', 'Category:', ['class' => 'control-label']) !!}
                                                {!! Form::select('u_category', $brands->pluck('name_en', 'id'), null, ['class' => 'form-select']) !!}
                                            ...
                                            <div class="input-group input-group-outline my-3">
                                                <label class="form-label">Name Ar</label>
                                                <input type="text" name="u_name_ar" id="u_name_ar" value=""
                                                    class="form-control" onfocus="focused(this)"
                                                    onfocusout="defocused(this)" required>
                                            </div>
                                            ...
                                            {{-- <div class="container">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12 col-md-offset-12">
                                                        <div class="form-group">
                                                            <div class="main-img-preview">
                                                                <img class="thumbnail u-img-preview"
                                                                    src="<?php echo url('/') . '/images/no_image.png'; ?>">
                                                            </div>
                                                            <div class="input-group">
                                                                <div class="input-group-btn">
                                ...
                                <table class="table table-flush datatable_search">
                                    <thead class="thead-light">
                                        ...
                                        <tr>
                                            ...
                                            <th class="d-none d-sm-table-cell" style="width: 20%;"">Name En</th>
                                            <th class=" d-none d-sm-table-cell" style="width: 20%;">Name Arabic</th>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            if (brands.length > 0) {
                ...
                document.getElementById("u_name_ar").value = brands[0].name_ar;
            ...
            $("#u_category").on('change', function() {
                var el = $(this);
                var select = $("#u_category")[0];
                // alert(el.val());

                var brands = <?php echo json_encode($brands); ?>;
                // var imageBaseUrl = <?php echo url('.'); ?>;

                document.getElementById("u_name_en").value = brands[brands.findIndex(x => x.id == el
                    .val())].name_en;
                document.getElementById("u_name_ar").value = brands[brands.findIndex(x => x.id == el
                    .val())].name_ar;
