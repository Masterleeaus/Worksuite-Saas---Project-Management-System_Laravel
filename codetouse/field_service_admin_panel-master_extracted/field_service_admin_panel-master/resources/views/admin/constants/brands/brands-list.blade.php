                                    ...
                                    <div class="card card-plain">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div>
                                                ...
                                                {!! Form::label('u_parent_brand_id', 'Parent Brands:', ['class' => 'control-label']) !!}
                                                {!! Form::select('u_parent_brand_id', $parentBrands->pluck('name_en', 'id'), null, ['class' => 'form-select']) !!}

                                            </div>
                                            <input hidden readonly name="brand"  id="brand" value="" type="text"/>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            if (brands.length > 0) {
                ...
                document.getElementById("brand").value = brands[0].id;
...
if (index> -1) {
    ...
    document.getElementById("brand").value = brands[index].id;
    document.getElementById("no_u_image").src = url + "/" +
    brands[index].image;
}
}
