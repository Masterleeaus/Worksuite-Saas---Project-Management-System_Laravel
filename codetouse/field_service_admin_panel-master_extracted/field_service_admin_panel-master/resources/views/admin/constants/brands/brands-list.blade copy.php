                                    ...
                                    <div class="card card-plain">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div>
                                                ...
                                                {!! Form::label('parent_brand_id', 'Parent Brand:', ['class' => 'control-label']) !!}
                                                {!! Form::select('parent_brand_id', $parentBrands->pluck('name_en', 'id'), null, ['class' => 'form-select']) !!}
                                    ...
                                    <div class="card card-plain">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div>
                                                ...
                                                {!! Form::label('u_parent_brand_id', 'Parent Brand:', ['class' => 'control-label']) !!}
                                                {!! Form::select('u_parent_brand_id', $parentBrands->pluck('name_en', 'id'), null, ['class' => 'form-select']) !!}

                                            </div>
                                            <input hidden readonly name="brand"  id="brand" value="9" type="text"/>
                        ...
                        <div class="card">
                             <div class="card-header">
                                ...
                                <div class="row" style="display: flex;justify-content: space-between;">
                                    <div class="col-sm-4"><h5 class="mb-0">Brands List </h5>
                                    </div>
                                ...
                                <table class="table table-flush datatable_search">
                                    <thead class="thead-light">
                                        ...
                                        <tr>
                                            ...
                                            <th class="d-none d-sm-table-cell" style="width: 20%;"">Parent Brand</th>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            if (brands.length > 0) {
                ...
                document.getElementById("u_name_en").value = brands[0].name_en;
                document.getElementById("parent_brand").value = brands[0].id;
        ...
        function setUpdateItem(id)
{
    ...
    var brands = <?php echo json_encode($brands); ?>;
    var parentBrands = <?php echo json_encode($parentBrands); ?>;
...
if (index> -1) {
    document.getElementById("u_parent_brand_id").selectedIndex = parentBrands.findIndex(y => y.id == brands[index].parent_brand_id);
    document.getElementById("u_name_en").value = brands[index].name_en;
    document.getElementById("parent_brand").value = brands[index].id;
    document.getElementById("no_u_image").src = url + "/" +
    brands[index].image;
}
}
