...
@section('content')
                                    ...
                                    <div class="card card-plain">
                                        ...
                                        <div class="card-body">
                                            ...
                                            {{-- <div hidden >
                                                ...
                                                {!! Form::label('u_parent_brand', 'Category:', ['class' => 'control-label']) !!}
                                                {!! Form::select('u_parent_brand', $parentBrands->pluck('name_en', 'id'), null, ['class' => 'form-select']) !!}

                                            </div> --}}
                                            <input hidden readonly name="u_parent_brand"  id="u_parent_brand" value="9" type="text"/>
                        ...
                        <div class="card">
                             <div class="card-header">
                                ...
                                <div class="row" style="display: flex;justify-content: space-between;">
                                    <div class="col-sm-4"><h5 class="mb-0">Parent Brands List </h5>
                                    </div>
    ...
    <script>
        $('.datatable_search').DataTable({
            ...
            ajax: "{{ route('parent_brands.anyData') }}",
            columns: [{
                    data: 'id',
                    name: 'id'
                },
        ...
        $(document).ready(function() {
            ...
            if (parentBrands.length > 0) {
                ...
                document.getElementById("u_name_en").value = parentBrands[0].name_en;
                document.getElementById("u_parent_brand").value = parentBrands[0].id;
 
                document.getElementById("no_u_image").src = url + "/" +
                    parentBrands[0].image;
            }
...
if (index> -1) {
    ...
    document.getElementById("u_name_en").value = parentBrands[index].name_en;
    document.getElementById("u_parent_brand").value = parentBrands[index].id;

    document.getElementById("no_u_image").src = url + "/" +
        parentBrands[index].image;
}
}
    </script>
