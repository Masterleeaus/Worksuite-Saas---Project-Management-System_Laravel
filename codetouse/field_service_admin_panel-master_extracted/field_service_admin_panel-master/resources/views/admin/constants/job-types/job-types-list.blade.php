...
@section('content')
                                    ...
                                    <div class="card card-plain">
                                        ...
                                        <div class="card-body">
                                            ...
                                            {{-- <div hidden >
                                                ...
                                                {!! Form::label('u_job_type', 'Category:', ['class' => 'control-label']) !!}
                                                {!! Form::select('u_job_type', $jobTypes->pluck('name_en', 'id'), null, ['class' => 'form-select']) !!}

                                            </div> --}}
                                            <input hidden readonly name="u_job_type"  id="u_job_type" value="9" type="text"/>
                        ...
                        <div class="card">
                             <div class="card-header">
                                ...
                                <div class="row" style="display: flex;justify-content: space-between;">
                                    <div class="col-sm-4"><h5 class="mb-0">Job Types List </h5>
                                    </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var jobTypes = <?php echo json_encode($jobTypes); ?>;

            if (jobTypes.length > 0) {

                document.getElementById("u_name_en").value = jobTypes[0].name_en;
                document.getElementById("u_job_type").value = jobTypes[0].id;
...
if (index> -1) {
    ...
    document.getElementById("u_name_en").value = jobTypes[index].name_en;
    document.getElementById("u_job_type").value = jobTypes[index].id;

    document.getElementById("no_u_image").src = url + "/" +
        jobTypes[index].image;
}
}
    </script>
