...
@section('content')
                            ...
                            <div class="modal-content">
                                <div class="modal-body p-0">
                                    <div class="card card-plain">
                                        ...
                                        <div class="card-body">
                                            {!! Form::open([
                                                'route' => 'sub_categories.add',
                                                'files' => true,
                                            ]) !!}
                                            <div>

                                                {!! Form::label('sub_major_category_id', 'Major Category:', ['class' => 'control-label']) !!}
                                                {!! Form::select('sub_major_category_id', $subMajorCategories->pluck('name_en', 'id'), null, ['class' => 'form-select']) !!}
                                    ...
                                    <div class="card card-plain">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div>
                                                ...
                                                {!! Form::label('u_sub_major_category_id', 'Major Category:', ['class' => 'control-label']) !!}
                                                {!! Form::select('u_sub_major_category_id', $subMajorCategories->pluck('name_en', 'id'), null, ['class' => 'form-select']) !!}

                                            </div>
                                            <input hidden readonly name="sub_category"  id="sub_category" value="" type="text"/>
                        ...
                        <div class="card">
                             <div class="card-header">
                                ...
                                <div class="row" style="display: flex;justify-content: space-between;">
                                    <div class="col-sm-4"><h5 class="mb-0">Sub Categories List </h5>
                                    </div>
    ...
    <script>
        $('.datatable_search').DataTable({
            ...
            ajax: "{{ route('sub_categories.anyData') }}",
            columns: [{
                    data: 'id',
                    name: 'id'
                },
                ...
                {
                    data: 'sub_major_category_name',
                    name: 'sub_major_category_name'
                },
        ...
        $(document).ready(function() {
            ...
            if (subCategories.length > 0) {
                ...
                document.getElementById("u_name_en").value = subCategories[0].name_en;
                document.getElementById("sub_category").value = subCategories[0].id;
...
if (index> -1) {
    document.getElementById("u_sub_major_category_id").selectedIndex = subMajorCategories.findIndex(y => y.id == subCategories[index].sub_major_category_id);
    document.getElementById("u_name_en").value = subCategories[index].name_en;
    document.getElementById("major_category").value = subCategories[index].id;
    document.getElementById("no_u_image").src = url + "/" +
