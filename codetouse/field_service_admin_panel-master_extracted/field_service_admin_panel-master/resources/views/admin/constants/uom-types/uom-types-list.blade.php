...
@section('content')
                                    ...
                                    <div class="card card-plain">
                                        ...
                                        <div class="card-body">
                                            ...
                                            {{-- <div hidden >
                                                ...
                                                {!! Form::label('u_uom_type', 'Category:', ['class' => 'control-label']) !!}
                                                {!! Form::select('u_uom_type', $uomTypes->pluck('name_en', 'id'), null, ['class' => 'form-select']) !!}

                                            </div> --}}
                                            <input hidden readonly name="u_uom_type"  id="u_uom_type" value="9" type="text"/>
                        ...
                        <div class="card">
                             <div class="card-header">
                                ...
                                <div class="row" style="display: flex;justify-content: space-between;">
                                    <div class="col-sm-4"><h5 class="mb-0">UOM Types List </h5>
                                    </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var uomTypes = <?php echo json_encode($uomTypes); ?>;

            if (uomTypes.length > 0) {

                document.getElementById("u_name_en").value = uomTypes[0].name_en;
                document.getElementById("u_uom_type").value = uomTypes[0].id;
...
if (index> -1) {
    ...
    document.getElementById("u_name_en").value = uomTypes[index].name_en;
    document.getElementById("u_uom_type").value = uomTypes[index].id;

    document.getElementById("no_u_image").src = url + "/" +
        uomTypes[index].image;
}
}
    </script>
