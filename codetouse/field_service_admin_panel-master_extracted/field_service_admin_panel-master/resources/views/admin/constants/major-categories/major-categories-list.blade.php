...
@section('content')
                                    ...
                                    <div class="card card-plain">
                                        ...
                                        <div class="card-body">
                                            ...
                                            {{-- <div hidden >
                                                ...
                                                {!! Form::label('major_category', 'Category:', ['class' => 'control-label']) !!}
                                                {!! Form::select('major_category', $major_categories->pluck('name_en', 'id'), null, ['class' => 'form-select']) !!}

                                            </div> --}}
                                            <input hidden readonly name="major_category"  id="major_category" value="9" type="text"/>
                        ...
                        <div class="card">
                             <div class="card-header">
                                ...
                                <div class="row" style="display: flex;justify-content: space-between;">
                                    <div class="col-sm-4"><h5 class="mb-0">Major Categories List </h5>
                                    </div>
    ...
    <script>
        $('.datatable_search').DataTable({
            ...
            ajax: "{{ route('major_categories.anyData') }}",
            columns: [{
                    data: 'id',
                    name: 'id'
                },
        ...
        $(document).ready(function() {
            ...
            if (majorCategories.length > 0) {
                ...
                document.getElementById("u_name_en").value = majorCategories[0].name_en;
                document.getElementById("major_category").value = majorCategories[0].id;
 
                document.getElementById("no_u_image").src = url + "/" +
                    majorCategories[0].image;
            }
        ...
        function setUpdateItem(id)
{
    ...
    var index=-1;
    var i=-1;
    majorCategories.forEach(element => {
        i+=1;;
        if(element?.id==id)
        {
            index=i;
...
if (index> -1) {
    ...
    document.getElementById("u_name_en").value = majorCategories[index].name_en;
    document.getElementById("major_category").value = majorCategories[index].id;

    document.getElementById("no_u_image").src = url + "/" +
        majorCategories[index].image;
}
}
    </script>
