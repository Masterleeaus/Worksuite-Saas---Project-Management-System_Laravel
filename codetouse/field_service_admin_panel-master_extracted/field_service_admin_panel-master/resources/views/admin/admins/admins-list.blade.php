                        ...
                        <div class="card">
                             <div class="card-header">
                                ...
                                <div class="row" style="display: flex;justify-content: space-between;">
                                    <div class="col-sm-4"><h5 class="mb-0"> Admin List </h5>
                                    </div>
                                    <div class="col-sm-4"><a type="button" class="btn btn-outline-primary mb-3" href="{{route("admins.create")}}" >Add New  Admin</a> </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            if (admins.length > 0) {
                ...
                document.getElementById("u_name").value = admins[0].name;
                document.getElementById("u_sub_admin").value = admins[0].id;
...
if (index> -1) {
    ...
    document.getElementById("u_name").value = admins[index].name;
    document.getElementById("u_sub_admin").value = admins[index].id;
