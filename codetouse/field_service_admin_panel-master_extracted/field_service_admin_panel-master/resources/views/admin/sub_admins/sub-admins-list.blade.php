...
@section('content')
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="input-group input-group-outline my-3">
                                                ...
                                                <input type="email" name="email" value="" class="form-control"
                                                    onfocus="focused(this)" value="" onfocusout="defocused(this)" required>
                                            </div>
                                            <div class="input-group input-group-outline my-3">
                                ...
                                <div class="modal-body p-0">
                                    <div class="card card-plain">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <input hidden readonly name="u_sub_admin"  id="u_sub_admin" value="9" type="text"/>
                        ...
                        <div class="card">
                             <div class="card-header">
                                ...
                                <div class="row" style="display: flex;justify-content: space-between;">
                                    <div class="col-sm-4"><h5 class="mb-0">Super Admin List </h5>
                                    </div>
                                    <div class="col-sm-4"><a type="button" class="btn btn-outline-primary mb-3" href="{{route("sub_admins.create")}}" >Add New Super Admin</a> </div>
                                ...
                                <table class="table table-flush datatable_search">
                                    <thead class="thead-light">
                                        ...
                                        <tr>
                                            ...
                                            <th class="d-none d-sm-table-cell" style="width: 20%;"">Contact</th>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var subAdmins = <?php echo json_encode($subAdmins); ?>;

            if (subAdmins.length > 0) {

                document.getElementById("u_name").value = subAdmins[0].name;
                document.getElementById("u_sub_admin").value = subAdmins[0].id;
...
if (index> -1) {
    ...
    document.getElementById("u_name").value = subAdmins[index].name;
    document.getElementById("u_sub_admin").value = subAdmins[index].id;

    document.getElementById("no_u_image").src = url + "/" +
        subAdmins[index].image;
}
}
    </script>
