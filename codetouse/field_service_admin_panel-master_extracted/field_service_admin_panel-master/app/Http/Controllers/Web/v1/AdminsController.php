...
class AdminsController extends Controller
{
    ...
    {
        $subAdmins=User::where("app_user_type",1)->get();
       return view("admin.admins.admins-list")->withAdmins($subAdmins);
    }
    ...
    {
        return datatables()->of(User::where("app_user_type",1)->select(['*'])->orderBy('id', 'desc'))
    ...
    public function request_update($id)
    {
        ...
        return view("admin.admins.admins-update")->withAdmin($user);
