import 'package:titan_go/common/widgets/code_picker_widget.dart';
  ...
  Widget build(BuildContext context) {
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        hintStyle: robotoRegular.copyWith(color: Theme.of(context).hintColor.withValues(alpha:0.5),fontSize: Dimensions.fontSizeDefault),
        prefixIcon: widget.countryDialCode == null ? SizedBox(width: 120, child: Align(
          ...
          child: Text(widget.title!, style: robotoMedium.copyWith(color: Theme.of(context).primaryColor,fontSize: Dimensions.fontSizeDefault),),
        )) : Container(
            width: 120,
