...
import 'package:titan_go/feature/booking_details/widget/timeline/timeline_node.dart';
import 'package:titan_go/feature/booking_details/widget/timeline/timeline_theme.dart';
import 'package:titan_go/feature/booking_details/widget/timeline/timeline_tile.dart';
  ...
  factory TimelineTileBuilder.connectedFromStyle({
    ...
    return TimelineTileBuilder(
      ...
      startConnectorBuilder: _createConnectedStartConnectorBuilder(
        ...
        connectorBuilder: (context, index, _) => _createStyledConnectorBuilder(
