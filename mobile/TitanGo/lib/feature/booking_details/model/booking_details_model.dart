...
class ServiceAddress {
  ...
  // ── Nexus / FSM site-memory fields (populated from /api/nexus/v1/dashboard
  //    or /api/fsm/v1/orders/{id} location object) ───────────────────────────
  String? entryInstructions;
  String? accessCode;
  String? parkingNotes;
  String? equipmentLocation;
  String? repeatInstructions;
  ...
  ServiceAddress.fromJson(Map<String, dynamic> json) {
    ...
    // FSM/Nexus site-memory fields
    entryInstructions  = json['entry_instructions'];
    accessCode         = json['access_code'];
    parkingNotes       = json['parking_notes'];
    equipmentLocation  = json['equipment_location'];
    repeatInstructions = json['repeat_instructions'];
    customerPreferences = json['customer_preferences'];
